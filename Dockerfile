...
RUN bash ./datasets/download_pix2pix_dataset.sh map2sat
RUN bash ./datasets/download_pix2pix_dataset.sh facades_label2photo
RUN bash ./datasets/download_pix2pix_dataset.sh day2night
